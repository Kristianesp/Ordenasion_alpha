...
def set_theme_colors(colors: dict):
    ...
    _THEME_COLORS.update({
        ...
        'primary_dark': colors.get('button_hover', colors.get('secondary', _THEME_COLORS['primary_dark'])),
        ...
        'text_secondary': colors.get('text_secondary', _THEME_COLORS['text_secondary']),
        'text_disabled': colors.get('text_disabled', _THEME_COLORS['text_disabled']),
        ...
        'border_light': colors.get('surface_variant', _THEME_COLORS['border_light']),
        'shadow': 'rgba(0, 0, 0, 0.1)',
    })
