...
class ThemeApplier:
    ...
    def _apply_to_children(
        parent: QWidget, palette: QPalette, css_styles: str, force_override: bool
    ):
                ...
                if (
                    ...
                    try:
                        ...
                        ThemeApplier._apply_to_children(
                            child, palette, css_styles, force_override
                        )
    ...
    def apply_theme_to_dialog(
        dialog: QDialog, theme_name: str = None, font_size: int = None
    ) -> bool:
        """
        ...
        try:
            ...
            ThemeApplier.apply_theme_to_widget(
                dialog, theme_name, font_size, force_override=True
            )
            ...
            for widget in app.allWidgets():
                if isinstance(widget, QWidget):
                    try:
                        ...
                        ThemeApplier.apply_theme_to_widget(
                            widget, theme_name, font_size, force_override=True
                        )
                    except Exception:
                        continue
